...
top_limit = 2000
bottom_limit = 950
input_offset_mv = 0 # 27.6518 #23.2184 # 26.62 # tested for channel 3
...
config = class_config()
adc = class_get_adc(scan_size,channel,config,default_gain,top_limit,bottom_limit,input_offset_mv,input_amp_gain,CT_resister,CT_ratio)
